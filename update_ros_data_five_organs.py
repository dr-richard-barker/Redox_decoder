 ...
 * ROS stimulus signature matrices, temporal classes, and 5-organ ggPlantMap spatial geometries.
 */
...
window.ROS_DECODER_DATA.ggPlantMapCells = {json.dumps(five_organs)};
"""

    with open("data/ros_decoder_data.js", "w") as f:
        f.write(output_js)

    print("Updated data/ros_decoder_data.js with 5 distinct organ maps and corrected anatomical layer profiles!")
